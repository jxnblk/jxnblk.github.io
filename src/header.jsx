  ...
  render: function() {
    return (
      <header className="px2">
        <div className="flex flex-center flex-wrap py2 border-bottom border-thick border-aqua">
          <a href="/" className="h2 block mr2 black">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="1.5em" height="1.5em" className="block">
          ...
          <div className="flex-auto">
            <h1 className="h2 m0">{this.props.title}</h1>
            <p className="h5 m0">{this.props.description}</p>
          </div>
          <nav>
