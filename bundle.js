	    ...
	    return (
	      React.createElement(Html, React.__spread({},  this.props, {script: script}), 
	        React.createElement("div", {className: "flex flex-column", 
	          ...
	          React.createElement("div", {className: "flex-auto px3"}, 
	            React.createElement(Home, React.__spread({},  this.props))
	          ), 
	          React.createElement(Footer, React.__spread({},  this.props)), 
	          React.createElement("script", {src: "js/ga.js"})
	        )
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("header", {className: "px3"}, 
	        React.createElement("div", {className: "border-bottom border-thick border-darken-1"}, 
	          React.createElement("div", {className: "flex flex-center flex-wrap py2 mxn1"}, 
	            React.createElement("a", {href: "/", className: "flex-none h3 block px1 black"}, 
	            ...
	            React.createElement("div", {className: "flex-auto flex flex-baseline"}, 
	              ...
	              React.createElement("p", {className: "h5 bold m0 ml1"}, this.props.name)
	            ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  render: function() {
	    return (
	      React.createElement("footer", {className: "px3 py3"}, 
	        React.createElement("div", {className: "flex flex-baseline flex-wrap mxn1"}, 
	          React.createElement("a", {href: "/", className: "m1 button button-link"}, this.props.title), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FeaturedProjects = __webpack_require__(9);
	var OtherProjects = __webpack_require__(10);
	var About = __webpack_require__(11);
	var Writing = __webpack_require__(12);
	  ...
	  render: function() {
	    return (
	      React.createElement("main", null, 
	        ...
	        React.createElement(Writing, React.__spread({},  this.props)), 
	        React.createElement(OtherProjects, React.__spread({},  this.props)), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ProjectCard = __webpack_require__(38);
	var classnames = __webpack_require__(97);
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("section", {id: "featured-projects", 
	        ...
	        React.createElement("h1", {className: "h6 caps mt0 mb2"}, "Featured Projects"), 
	        React.createElement("div", {className: "sm-flex flex-wrap mxn1"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  renderProject: function(project, i) {
	    ...
	    return (
	      React.createElement("div", {className: colClass, key: 'other-' + i}, 
	        React.createElement("a", {href: project.link, className: "block button button-transparent", title: 'View ' + project.name}, 
	          React.createElement("h2", {className: "h3 m0"}, project.name), 
	          React.createElement("p", {className: "h5 m0"}, project.description)
	        )
	      )
	    )
	  },
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("section", {id: "other-projects", 
	        className: "py3 border-bottom border-thick border-darken-1"}, 
	        React.createElement("h1", {className: "h6 caps mt0"}, "Other Projects"), 
	        React.createElement("div", {className: "sm-flex flex-wrap mxn2"}, 
	  ...
	  render: function() {
	    return (
	      React.createElement("section", {id: "about", 
	        ...
	        React.createElement("h1", {className: "h6 caps mt0"}, "About"), 
	        React.createElement("p", {className: "h3 m0"}, this.props.byline)
	      )
	    )
	  }
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  renderPost: function(post, i) {
	    var subheading = function(subheading) {
	      if (subheading) {
	        return (
	          React.createElement("h3", {className: "mt0"}, 
	            React.createElement("a", {href: post.link, className: ""}, 
	              post.subheading
	            )
	          )
	        )
	    ...
	    if (i < 3) {
	      return (
	        React.createElement("div", {className: "sm-col-12 md-col-4 px3 mb3", key: 'post-' + i}, 
	          React.createElement("h2", {className: "mb0"}, 
	            React.createElement("a", {href: post.link, className: "black"}, 
	              post.title, post.subheading ? ': ' + post.subheading : false
	            )
	          ), 
	          React.createElement("p", null, post.lead, " ", React.createElement("a", {href: post.link}, "Read more..."))
	        )
	      )
	    } else {
	      return (
	        React.createElement("div", {className: "sm-col-6 md-col-4 px3 mb3", key: 'post-' + i}, 
	          React.createElement("h2", {className: "h3 m0"}, 
	            React.createElement("a", {href: post.link, className: "black"}, post.title)
	          )
	        )
	      )
	    }
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("section", {id: "writing", 
	        className: "py3 border-bottom border-thick border-darken-1"}, 
	        React.createElement("h1", {className: "h6 caps mt0"}, "Writing"), 
	        React.createElement("div", {className: "sm-flex flex-wrap mxn3"}, 
	      ...
	      React.createElement("section", {className: classes.section}, 
	        React.createElement("a", {href: this.props.link, 
	          ...
	          React.createElement("div", {className: classes.content}, 
	            ...
	            React.createElement("h1", {className: classes.title, style: styles.h1}, this.props.name), 
	            React.createElement("p", {className: classes.description, style: styles.description}, this.props.description)
	          )
	        )
	      )
	    )
